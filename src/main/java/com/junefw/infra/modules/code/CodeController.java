...
public class CodeController {
	...
	/* Code s */
	  ...
	  @RequestMapping(value = "/code/codeForm") public String codeForm(Model model)
	  throws Exception {
	  ...
	  @RequestMapping(value = "/code/codeInst") public String codeInst( Code dto)
	  throws Exception {
	  ...
	  @RequestMapping(value = "/code/codeView") public String codeView(CodeVo vo,
	  Model model ) throws Exception {
	  
	  System.out.println("vo.getPilcdSeq("+vo.getPilcdSeq()+")");
	  ...
	  Model model ) throws Exception { //한건의 데이터를 가져오기위한 가져온값이vo에 담김
	 Code rt =   service.selectOne1(vo);
	  ...
	  @RequestMapping(value = "/code/codeUpdt") public String codeUpdt(Code dto)
	  throws Exception {
	  System.out.println("dto.getPilcdSeq("+dto.getPilcdSeq()+")");
	  System.out.println("dto.getPilcdSeq("+dto.getPilcdName()+")");
	  service.update1(dto);

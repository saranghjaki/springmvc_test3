...
<c:choose>
	...
	<c:otherwise>
		...
		<%-- <c:out value="${item.pilcgSeq}"/> | <a href="/infra/code/codeGroupView?pilcgSeq=<c:out value="${item.pilcgSeq}"/>&thisPage=<c:out value="${vo.thisPage}"/>&shOption=<c:out value="${vo.shOption}"/>&shValue=<c:out value="${vo.shValue}"/>"><c:out value="${item.pilcgName}"/></a> | <c:out value="${item.pilcgNameEng}"/> | <c:out value="${item.pilcgDelNy}"/> <br> --%>
